...
class GKExperimentController: UIViewController {
...
extension GKExperimentController: MKMapViewDelegate {
...
extension GKExperimentController: CLLocationManagerDelegate {
...
extension GKExperimentController {
    func setupGraph() {
